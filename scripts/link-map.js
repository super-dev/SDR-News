const developmentLinks = {
  communities: [
    ...
    {to: 'refind', iconClass: 'icon icon-refind', iconID: '#icon-refind', title: 'Refind'},
  ...
  blogs: [    
    ...
    {to: 'css-tricks', title: 'CSS Tricks'},
    {to: 'designshack', title: 'Design Shack'},
    {to: 'cssauthor', title: 'CSS Author'},
    {to: 'onextrapixel', title: 'Onextrapixel'},
    {to: 'designmodo', title: 'Designmodo'},
    {to: 'webdesignledger', title: 'Web Design Ledger'},
    {to: 'speckyboy', title: 'Speckyboy'},
    {to: 'codrops', title: 'Codrops'},
